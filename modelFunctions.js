...
function createMultiplyQuestion(minVal, maxVal, restricted, randomNumberGenerator) {
...
function createDivideQuestion(minVal, maxVal, restricted, randomNumberGenerator) {
